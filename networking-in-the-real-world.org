...
This bug was amazing. It was quite subtle and hard to spot because it took a
while to show up in games. Games had to last a while before the bug gradually
took hold. But the effect was that slowly, clients would get further and further
behind the server.
...
One side effect of this was that I knew that the network code was pretty robust.
